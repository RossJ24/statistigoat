...
plot(all_sd, main = "Standard Deviations of Goat Rating", xlab = "Player Name", ylab = "Goat Rating Standard Deviation", col = "red")
text("russell", "wilt", "kareem", "magic", "bird", "mj", "shaq", "duncan", "kobe", "LeBron")
...
plot(goat_compared_to_rest, main = "Player's average GR compared to era's average GR", xlab = "Player's Name", ylab = "GOAT divided by era's average Goat Rating")
```
