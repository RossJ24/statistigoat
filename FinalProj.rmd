...
```{r}
#bootstrapping the correlations between each variable and GOAT Rating(GR)

N <- nrow(szn_statsnb)

n_samp <- 10000

corResultsPPG <- rep(NA, n_samp)
corResultsAPG <- rep(NA, n_samp)
corResultsDRPG <- rep(NA, n_samp)
corResultsORPG <- rep(NA, n_samp)
corResultsTSP <- rep(NA, n_samp)
corResultsTPG <- rep(NA, n_samp)
corResultsPER <- rep(NA, n_samp)
corResultsBPG <- rep(NA, n_samp)
...
for(i in 1:n_samp){
  ...
  corResultsPPG[i] <- cor(fakeData[, 10], fakeData[, 2], use = "pairwise.complete.obs")
  corResultsAPG[i] <- cor(fakeData[, 10], fakeData[, 3], use = "pairwise.complete.obs")
  corResultsDRPG[i] <- cor(fakeData[, 10], fakeData[, 5], use = "pairwise.complete.obs")
  corResultsORPG[i] <- cor(fakeData[, 10], fakeData[, 4], use = "pairwise.complete.obs")
  corResultsTSP[i] <- cor(fakeData[, 10], fakeData[, 8], use = "pairwise.complete.obs")
  corResultsTPG[i] <- cor(fakeData[, 10], fakeData[, 7], use = "pairwise.complete.obs")
  corResultsPER[i] <- cor(fakeData[, 10], fakeData[, 9], use = "pairwise.complete.obs")
  corResultsBPG[i] <- cor(fakeData[, 10], fakeData[, 6], use = "pairwise.complete.obs")

}


#performing the correlations between each variable and GOAT rating(GR) in szn_statspavgs
print("Correlation between PPG and GR")
cor(szn_statsnb$aPPG, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between APG and GR")
cor(szn_statsnb$aAPG, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between DRPG and GR")
cor(szn_statsnb$aDRPG, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between ORPG and GR")
cor(szn_statsnb$aORPG, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between TSP and GR")
cor(szn_statsnb$aTSP, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between TPG and GR")
cor(szn_statsnb$aTPG, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between PER and GR")
cor(szn_statsnb$aPER, szn_statsnb$aGR, use = "pairwise.complete.obs")
print("Correlation between BPG and GR")
cor(szn_statsnb$aBPG, szn_statsnb$aGR, use = "pairwise.complete.obs")

#histograms of bootstrapped correlations with confidence intervals
ci_rPPG <- quantile(corResultsPPG, c(.025, .975))
hist(corResultsPPG, col = "blue", main = "Bootstrapped PPG Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rPPG, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aPPG)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))


ci_rAPG <- quantile(corResultsAPG, c(.025, .975))
hist(corResultsAPG, col = "blue", main = "Bootstrapped APG Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rAPG, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aAPG)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))


ci_rDRPG <- quantile(corResultsDRPG, c(.025, .975))
hist(corResultsDRPG, col = "blue", main = "Bootstrapped DRPG Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rDRPG, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aDRPG)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))


ci_rORPG <- quantile(corResultsORPG, c(.025, .975))
hist(corResultsORPG, col = "blue", main = "Bootstrapped ORPG Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rORPG, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aORPG)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))


ci_rTSP <- quantile(corResultsTSP, c(.025, .975))
hist(corResultsTSP, col = "blue", main = "Bootstrapped TSP Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rTSP, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aTSP)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))


ci_rTPG <- quantile(corResultsTPG, c(.025, .975))
hist(corResultsTPG, col = "blue", main = "Bootstrapped TPG Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rTPG, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aTPG)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))
...
ci_rBPG <- quantile(corResultsBPG, c(.025, .975))
hist(corResultsBPG, col = "blue", main = "Bootstrapped BPG Correlations", xlab = "Sample Correlation", breaks = 50)

abline(v = ci_rBPG, lwd = 3, col = "red")
abline(v = cor.test(szn_statsnb$aGR, szn_statsnb$aBPG)$conf.int, lwd = 3, col = "green", lty = 2)
legend("topleft", c("Theoretical CI","Boot CI"), lwd = 3, col = c("green","red"), lty = c(2, 1))
```
...
myCor(szn_statsnb$aPPG, szn_statsnb$aGR, "PPG", "GR")
myCor(szn_statsnb$aAPG, szn_statsnb$aGR, "APG", "GR")
myCor(szn_statsnb$aDRPG, szn_statsnb$aGR, "DRPG", "GR")
myCor(szn_statsnb$aORPG, szn_statsnb$aGR, "ORPG", "GR")
myCor(szn_statsnb$aTSP, szn_statsnb$aGR, "TSP", "GR")
myCor(szn_statsnb$aTPG, szn_statsnb$aGR, "TPG", "GR")
myCor(szn_statsnb$aPER, szn_statsnb$aGR, "PER", "GR")
myCor(szn_statsnb$aBPG, szn_statsnb$aGR, "BPG", "GR")
...
russel_sd <- (era_1_russell_gr - sd(era1$GR))/mean(era1$GR) 
wilt_sd <- (era_2_wilt_gr - sd(era2$GR))/mean(era2$GR) 

kareem_sd <- (era_2_kareem_gr - sd(era2$GR))/mean(era2$GR) 

magic_sd <- (era_3_magic_gr - sd(era3$GR))/mean(era3$GR)

bird_sd <- (era_3_bird_gr - sd(era3$GR))/mean(era3$GR)

mj_sd <- (era_4_mj_gr - sd(era4$GR))/mean(era4$GR)

shaq_sd <- (era_4_shaq_gr - sd(era4$GR))/mean(era4$GR)

td_sd <- (era_5_td_gr - sd(era5$GR))/mean(era5$GR)

kobe_sd <- (era_5_kobe_gr - sd(era5$GR))/mean(era5$GR)

lbj_sd <- (era_6_lbj_gr - sd(era6$GR))/mean(era6$GR)
```
